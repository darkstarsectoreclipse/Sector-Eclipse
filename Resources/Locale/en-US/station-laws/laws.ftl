...
lawset-name-ntdefault = NT Default
...
lawset-name-commandments = Ten Commandments
...
lawset-name-lall = Live and Let Live
...
lawset-name-efficiency = Station Efficiency
...
lawset-name-xenoborg = Xeno Borg
...
lawset-name-mothershipcore = Mothership Core
